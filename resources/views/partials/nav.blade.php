...
>
    <svg x-show="darkMode" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
...
<a href="https://github.com/z0mbiebrad" target="_blank" title="GitHub Profile">
    <div
        class="p-2 cursor-pointer text-neutral-600 hover:bg-zinc-400 dark:hover:bg-zinc-700 hover:rounded-md hover:text-black hover:cursor-pointer dark:text-neutral-300 dark:hover:text-white">
        <svg class="h-6 text-neutral-600 dark:text-neutral-300" xmlns="http://www.w3.org/2000/svg"
...
<a href="https://linkedin.com/in/bradleytevans" target="_blank" title="LinkedIn Profile">
    <div
        class="p-2 cursor-pointer text-neutral-600 hover:bg-zinc-400 dark:hover:bg-zinc-700 hover:rounded-md hover:text-black hover:cursor-pointer dark:text-neutral-300 dark:hover:text-white">
        <svg class="h-6 text-neutral-600 dark:text-neutral-300" xmlns="http://www.w3.org/2000/svg"
...
<a href="https://bradleytevans.com" target="_blank" title="Visit My Portfolio">
    <div
        class="p-2 cursor-pointer text-neutral-600 hover:bg-zinc-400 dark:hover:bg-zinc-700 hover:rounded-md hover:text-black hover:cursor-pointer dark:text-neutral-300 dark:hover:text-white">
